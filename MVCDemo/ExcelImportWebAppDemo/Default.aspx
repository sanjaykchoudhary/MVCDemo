<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Default.aspx.cs" Inherits="ExcelImportWebAppDemo.Default" %>

<!DOCTYPE html>

<html xmlns="http://www.w3.org/1999/xhtml">
<head runat="server">
    <title>Excel import in SQL Server</title>
        ...
        <div class="card">
            ...
            <div class="card-body">
                <button style="margin-bottom:10px;" type="button" class="btn btn-primary" data-toggle="modal" data-target="#myModal">
                    <i class="fa fa-plus-circle">Import Excel</i>
                </button>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <div class="input-group">
                                                <div class="custom-file">
                                                    <asp:FileUpload ID="fleUpload" runat="server" CssClass="custom-file-input" />
                ...
                <asp:GridView ID="gvUpload" runat="server" HeaderStyle-CssClass="bg-primary text-white" ShowHeaderWhenEmpty="true" AutoGenerateColumns="false"
